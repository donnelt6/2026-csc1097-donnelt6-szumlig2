...
class Settings:
    ...
    media_upload_max_bytes: int = int(os.getenv("MEDIA_UPLOAD_MAX_BYTES", str(50 * 1024 * 1024)))
    ...
    transcription_max_bytes: int = int(os.getenv("TRANSCRIPTION_MAX_BYTES", "25000000"))
